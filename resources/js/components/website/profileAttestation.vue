<template>
  <div>
    <h3 class="page-title">Quản lý hồ sơ ATTP &amp; chứng nhận</h3>
    <p class="text-muted mb-3">
      Nội dung hiển thị ở phần gallery “Hồ sơ ATTP &amp; Chứng nhận” trên trang Hồ sơ. Mỗi mục gồm ảnh và tiêu đề.
    </p>
    <div class="row">
              ...
              <div class="col-md-3">
                <div class="form-group">
                  ...
                  <image-upload
                    type="avatar"
                    v-model="item.image"
                    :title="'profile-attestation-' + (key + 1)"
                  ></image-upload>
                </div>
              </div>
              ...
              <div class="col-md-9">
                <div class="form-group">
                  ...
                  <vs-input
                    ...
                    v-model="item.title"
                    size="default"
                    placeholder="VD: Giấy chứng nhận ATTP"
                    class="w-100"
                  />
                </div>
                <div class="form-group">
...
export default {
  ...
  methods: {
    ...mapActions(["saveProfileAttestation", "listProfileAttestation", "loadings"]),
    ...
    saveItems() {
      ...
      this.loadings(true);
      this.saveProfileAttestation({ data: this.objData })
        .then(() => {
          this.loadings(false);
